...
<script language="javascript">
    ...
    function refreshOptions(){
        ...
        html += '<th><div class=""><div style="padding-bottom:10px;text-align:center;">卡路里</div><div class="input-group"><input type="text" class="form-control  input-sm option_credit_all"VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-angle-double-down" title="批量设置" onclick="setCol(\'option_credit\');"></a></span></div></div></th>';
