...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class='form-control-static'>
            <?php  if(!empty($item['recredit'])) { ?><?php  echo $item['reccredit'];?> 卡路里; <?php  } ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class="input-group">
            ...
            <div class="input-group-addon">卡路里&nbsp;&nbsp;&nbsp;每月最多</div>
        ...
        <div class="help-block">设置每月上限获得卡路里和现金数,默认0为不限制</div>
        <?php  } else { ?>
        <div class='form-control-static'>
            <?php  if(!empty($item['recredit'])) { ?>每月最多 <?php  echo $item['reccredit_totle'];?> 卡路里; <?php  } ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <?php  } else { ?>
        <div class='form-control-static'>
            <?php  if(!empty($item['subcredit'])) { ?><?php  echo $item['subcredit'];?> 卡路里; <?php  } ?>
