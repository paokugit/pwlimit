              ...
              <div class="panel-body">
                  ...
                  <div id="selected_rec_reward<?php  echo $rank;?>">
                      ...
                      <div class="form-group rec_reward_data"  id="rec_credit<?php  echo $rank;?>" data-rank="<?php  echo $rank;?>" data-type="1" data-value="<?php  echo $rec;?>" style="border-bottom:1px solid #f2f2f2;">
                          <label class="col-lg control-label"></label>
                          <div class="col-sm-7" style="padding-top: 8px;padding-bottom: 20px;">卡路里<span class="pull-right label label-success"  style="margin-right: 10px;"><?php  echo $rec;?></span></div>
                          <div class="col-lg">
...
<script type="text/javascript">
      ...
      function select_change(obj) {
          ...
          var div_item = '';
          if(select_item==1){
              div_item = '<div class="row"><div class="col-sm-4 col-xs-4"><input type="number" class="form-control" name="reccredit" placeholder="请输入卡路里">'
          ...
          if(datatype==1){
              ...
              if(reccredit>0){
                  ...
                  var btn_data = '<div class="form-group rec_reward_data"  data-rank="'+currank+'" data-type="1" data-value="'+reccredit+'" id="rec_credit'+currank+'" style="border-bottom:1px solid #f2f2f2;">'+
                          '<label class="col-lg control-label"></label>'+
                          '<div class="col-sm-7" style="padding-top: 8px;padding-bottom: 20px;">卡路里<span class="pull-right label label-success"  style="margin-right: 10px;">'+reccredit+'</span></div>'+
                          '<div class="col-lg">'+
                          '&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onclick="del_data(this);" class="btn btn-danger  btn-sm btn-delete-time">删除</button>'+
                          '</div></div>';
