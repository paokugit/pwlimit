	...
	<div class="tabs-container">
		...
		<div class="tabs">
			<ul class="nav nav-tabs">
				...
				<?php  if($helpList) { ?>
				<li class=""><a data-toggle="tab" href="#tab-help" aria-expanded="false">好友助力信息</a></li>
				<?php  } ?>
			...
			<div class="tab-content ">
				...
				<?php  if($helpList) { ?>
				<div id="tab-help" class="tab-pane "><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('member/detail/helplist', TEMPLATE_INCLUDEPATH)) : (include template('member/detail/helplist', TEMPLATE_INCLUDEPATH));?></div>
				<?php  } ?>
