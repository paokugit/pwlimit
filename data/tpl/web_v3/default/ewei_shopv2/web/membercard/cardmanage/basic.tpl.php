...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('membercard.cardmanage' ,$item) ) { ?>
        <label class="checkbox-inline"><input type="checkbox" name="is_card_points" value="1" <?php  if(!empty($item['is_card_points'])) { ?>checked="true"<?php  } ?> <?php  if(!empty($item['id'])) { ?>disabled<?php  } ?>  /> 卡路里</label>
        <?php  } else { ?>
        <div class='form-control-static'>
            <?php  if(!empty($item['is_card_points'])) { ?>卡路里<?php  } ?>
        </div>
        <?php  } ?>
    </div>
</div>
<div class="form-group" id="sendcredit1" <?php  if(empty($item['is_card_points'])) { ?>style="display: none;"<?php  } ?>>
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <span class='help-block'>开卡赠送的卡路里数值</span>
        <?php  } else { ?>
        <div class='form-control-static'>卡路里：<?php  echo $item['card_points'];?> 分</div>
        <?php  } ?>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('membercard.cardmanage' ,$item) ) { ?>
        <label class="checkbox-inline"><input type="checkbox" name="is_month_points" value="1" <?php  if(!empty($item['is_month_points'])) { ?>checked="true"<?php  } ?>  <?php  if(!empty($item['id'])) { ?>disabled<?php  } ?> /> 卡路里</label>
        <?php  } else { ?>
        <div class='form-control-static'>
            <?php  if(!empty($item['is_month_points'])) { ?>卡路里<?php  } ?>
        </div>
        <?php  } ?>
    </div>
</div>
<div class="form-group" id="monthcredit1" <?php  if(empty($item['is_month_points'])) { ?>style="display: none;"<?php  } ?>>
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <span class='help-block'>开卡后每个月可以领取卡路里数值</span>
        <?php  } else { ?>
        <div class='form-control-static'><?php  echo $item['month_points'];?> 卡路里</div>
        <?php  } ?>
    </div>
</div>
<div class="form-group">
