<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
    <label class="col-lg control-label">充值送卡路里</label>
    <div class="col-sm-9">
        ...
        <span class="help-block">两项都填写才能生效 例如 填写 满10元 赠送比例为1比1卡路里  则赠送10*1=10卡路里 <br/>这里的充值送卡路里可能和交易设置里面的账户充值送卡路里有冲突,如果您在这里设置了,那边会相应的关闭(避免重复赠送)</span>
    </div>
</div>
