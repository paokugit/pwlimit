    ...
    <div class="panel " >
        <div class="panel-body">
            <div class="col-sm-9 col-xs-12">
                <h4 class="set_title">卡路里抵扣</h4>
                <span> 开启卡路里抵扣, 商品最多抵扣的数目需要在商品【营销设置】中单独设置</span>
            </div>
        ...
        <label class="pull-left" style="margin-left: 40px">卡路里抵扣比例</label>
        <div class="col-sm-5">
            <?php if(cv('sale.deduct')) { ?>
            <div class='input-group fixsingle-input-group'>
                <input type="hidden" name="data[credit]" value="1" class="form-control" />
                <span class='input-group-addon'>1个卡路里 抵扣</span>
                <input type="text" name="data[money]"  value="<?php  echo $data['money'];?>" class="form-control" />
                <span class='input-group-addon'>元</span>
            </div>
            <span class='help-block'>卡路里抵扣比例设置</span>
            <?php  } else { ?>
            <div class='form-control-static'><?php  echo $data['credit'];?>卡路里 抵扣 <?php  echo $data['money'];?> 元</div>
            <?php  } ?>
        </div>
    </div>
