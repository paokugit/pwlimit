...
<div class='page-header'>
    当前位置：<span class="text-primary">绑定手机号送卡路里</span>
</div>
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="col-sm-9 col-xs-12">
                    <h4 class="set_title">绑定手机号送卡路里</h4>
                    <span> 开启绑定手机号送卡路里, 用户绑定手机号后会获得指定卡路里</span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('sale.bindmobile')) { ?>
                            ...
                            <span class='help-block'>开启后用户首次绑定手机号会获得指定卡路里(包含wap与小程序)</span>
                        <?php  } else { ?>
                            <div class='form-control-static'>{$data['bindmobilecredit'])}卡路里</div>
                        <?php  } ?>
                    </div>
                </div>
            </div>
