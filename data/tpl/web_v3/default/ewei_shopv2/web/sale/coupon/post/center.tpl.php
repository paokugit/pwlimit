...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12" >
        ...
        <span class='help-block'>会员是否可以通过链接直接获取优惠券.注意!!!此功能无法与支付与卡路里兑换优惠券功能同时使用!!!</span>
...
<div class="gettype" <?php  if($item['gettype']!=1) { ?>style="display:none"<?php  } ?>>
    ...
    <div class="form-group gettype" >
        ...
        <div class="col-sm-9 col-xs-12" >
            ...
            <div class="input-group">
                ...
                <span class="input-group-addon">卡路里 + 花费</span>
            ...
            <span class="help-block">每人限领，空不限制，领取方式可任意组合，可以单独卡路里兑换，单独现金兑换，或者卡路里+现金形式兑换, 如果都为空，则可以免费领取</span>
    ...
    <div class="form-group gettype" >
        <label class="col-lg control-label"></label>
        <div class="col-sm-9 col-xs-12" >
            <div class='form-control-static'>消耗 <?php  echo $item['credit'];?> 卡路里 花费 <?php  echo $item['money'];?> 元现金</div>
        </div>
    </div>
    <?php  } ?>
