...
<div class="page-content">
    ...
    <form action="" <?php if(mcv('diypage.shop.menu.save')) { ?>method="post"<?php  } ?> class="form-horizontal form-validate">
            ...
            <div class="col-sm-9 col-xs-12">
                        <div class="col-sm-6 col-xs-6" style="padding:0;">
                            <div class="input-group">
                                ...
                                <select class="form-control valid select2"<?php if(mcv('diypage.shop.menu.save')) { ?>name="menu[shop]"<?php  } else { ?>readonly<?php  } ?>>
                        ...
                        <div class="col-sm-6 col-xs-6" style="padding:0;">
                            <div class="input-group">
                                ...
                                <select class="form-control valid select2"<?php if(mcv('diypage.shop.menu.save')) { ?>name="menu[shop_wap]"<?php  } else { ?>readonly<?php  } ?>>
                                <option value="">系统默认</option>
                                <?php  if(is_array($list)) { foreach($list as $item) { ?>
                ...
                <?php  if(!empty($status) && p($plugin)) { ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <div class="input-group">
                                <div class="input-group-addon">微信端</div>
                                <select class="form-control valid select2"<?php if(mcv('diypage.shop.menu.save')) { ?>name="menu[<?php  echo $plugin;?>]"<?php  } else { ?>readonly<?php  } ?>>
                                    <option value="">系统默认</option>
                                    <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                ...
                                <div class="input-group-addon" style="border-left: 0; border-right: 0">WAP端</div>
                                <select class="form-control valid select2"<?php if(mcv('diypage.shop.menu.save')) { ?>name="menu[<?php  echo $plugin;?>_wap]"<?php  } else { ?>readonly<?php  } ?>>
                                    <option value="">系统默认</option>
                                    <?php  if(is_array($list)) { foreach($list as $item) { ?>
        ...
        <?php if(mcv('diypage.shop.menu.save')) { ?>
            <div class="form-group">
