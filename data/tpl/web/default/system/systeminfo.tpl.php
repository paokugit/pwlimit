	...
	<table class="table we7-table table-hover site-list" id="system-info" ng-controller="systemInfoCtrl" ng-cloak>
		...
		<tr>
			...
			<td class="text-left">WeEngine <?php  echo IMS_VERSION;?> Release <?php  echo IMS_RELEASE_DATE;?> &nbsp; &nbsp;
				<a href="https://item.taobao.com/item.htm?spm=a230r.1.14.344.152b7f16sVJNoy&id=576602488411&ns=1&abbucket=18#detail" target="_blank" style="color: #428bca;">查看最新版本</a>
			</td>
		</tr>
		<tr>
	...
	<table class="table we7-table table-hover site-list">
		...
		<tr>
			...
			<td>
				...
				<a href="https://www.linxincn.com/" class="lightlink2" target="_blank" style="color: #428bca;">林心博客</a>&nbsp;&nbsp;
